...
from app.domains.image_generation.schemas import GenerateImageRequest, GenerateImageToR2Request, R2KeyResponse
...
async def generate_images_r2_endpoint(request: Request, payload: GenerateImageToR2Request):
